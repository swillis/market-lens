  ...
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-6">
        <div className="flex justify-between">
          <div>
            ...
            <div className="mt-2 h-5 w-48 rounded bg-zinc-100" />
          </div>
          <div className="text-right">
            <div className="h-8 w-28 rounded bg-zinc-100" />
            <div className="mt-2 h-5 w-32 rounded bg-zinc-100" />
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-6">
        ...
        {[1, 2, 3].map((i) => (
          <div key={i} className="mb-3 rounded-lg border border-zinc-100 bg-zinc-50 p-4">
